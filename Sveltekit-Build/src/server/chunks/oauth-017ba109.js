...
var httpAdapter = isHttpAdapterSupported && function httpAdapter(config) {
  return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
    ...
    if (config.transport) {
      ...
      transport = isHttpsRequest ? require$$4 : http;
    } else {
...
function requireVerify () {
	...
	const {KeyObject, createSecretKey, createPublicKey} = require$$2$1;
...
function requireSign () {
	...
	const { KeyObject, createSecretKey, createPrivateKey } = require$$2$1;
...
async function refreshToken(apiUrl, refreshToken2) {
  ...
  const response = await axios$1.post(url).catch(function(err) {
    if (err.response) {
...
export { axios$1 as a, getToken as b, requireProxyFromEnv as c, requireFollowRedirects as d, generateAuthLink as g, requireForm_data as r };
//# sourceMappingURL=oauth-017ba109.js.map
