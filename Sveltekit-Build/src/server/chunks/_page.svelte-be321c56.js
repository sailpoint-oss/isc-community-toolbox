import { c as create_ssr_component, v as validate_component, e as escape } from './ssr-3eccf1b3.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `<div class="z-50 mx-auto flex h-full items-center justify-center p-4 md:p-0"><div class="card card-glass z-50 space-y-5 p-4 md:p-10"><div class="skills svelte-1285lhc">${validate_component(AnimatedCounter, "AnimatedCounter").$$render(
    $$result,
    {
      interval: 1500,
...
//# sourceMappingURL=_page.svelte-be321c56.js.map
