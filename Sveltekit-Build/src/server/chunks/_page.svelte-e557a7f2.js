...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<main><div class="p-4"><div class="flex justify-center mt-4 flex-col align-middle"><div class="text-2xl py-2 text-center" data-svelte-h="svelte-1j7u3yh">Listing of sources and their delete threshold</div> ${`${validate_component(Progress, "Progress").$$render($$result, {}, {}, {})}`}</div></div></main>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-e557a7f2.js.map
